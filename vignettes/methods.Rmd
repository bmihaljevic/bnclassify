...
This vignette provides details about some of the implemented functionalities. A comprehensive list of the functionalities is listed with \texttt{?bnclassify}. The "introduction" vignette presents examples and shows how to combine the existing functions. The first part of this vignette provides background and lists all implemented functionalities. The remaining sections details on some of the implemented methods.
