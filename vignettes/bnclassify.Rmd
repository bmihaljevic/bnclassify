...
The wrapper algorithms can be computation-intensive, especially with large data sets. I get the following times for `bsej` and `tan_hc` on my Windows 2.80 GHz, 16 GB RAM machine. 
...
Inference with incomplete data is veyr slow. Thus, we remove incomplete instances.
```{r}
