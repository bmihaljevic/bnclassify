...
## Documentation 
Calling \code{?bnclassify} gives an overview of the functionalities, with pointers to relevant functions and their documentation. The \invin/ presents examples and shows how to combine the existing functions. The \tecvin/ provides details about some of the underlying methods and our implementation.  **TODO!!!!!!!!!!!** 
